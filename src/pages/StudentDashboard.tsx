                ...
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                  ...
                  <CardContent>
                    <div className="space-y-3 mt-2">
                      {scriptNotifications.length > 0 ? (
                        scriptNotifications.map((notif) => (
                          <Link
                            key={notif.id}
                            to="/script-analyzer"
                            className="block"
                          >
                            <div className="border border-gray-100 rounded-xl p-4 bg-white hover:shadow-sm transition-all duration-300 hover:border-indigo-200">
                              <div className="flex items-center justify-between mb-2">
                                <h5 className="text-sm font-semibold text-gray-900">
                                  {notif.script_analyses?.title}
                                </h5>
                      ...
                      {submissions.slice(0, 5).map((submission) => (
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <Badge
                              className={`text-xs px-3 py-1 rounded-full ${submission.status === "graded"
                        ...
                        {assignments.slice(0, 6).map((assignment) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-center justify-between">
                                <span
                                  className={`text-sm font-medium ${isOverdue ? "text-red-600" : "text-gray-500"
                                    }`}
                                >
                                  Due:{" "}
                      ...
                      {assignments
                        ...
                        .map((assignment) => {
                          ...
                          return (
                            <div
                              key={assignment.id}
                              className={`border-2 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg ${isOverdue
                            ...
                            >
                              <div className="flex items-start gap-3 mb-4">
                                <div
                                  className={`p-2 rounded-xl ${isOverdue
                                      ? "bg-red-500"
                                      : daysUntilDue <= 3
                                        ? "bg-amber-500"
                                        : "bg-blue-500"
                              ...
                              <Link to={`/assignment/${assignment.id}`}>
                                <Button
                                  className={`w-full shadow-lg hover:shadow-xl transition-all duration-300 ${isOverdue
